...
document.getElementById("play-gif-2").addEventListener("click", function () { e.start() });
document.getElementById("stop-gif-2").addEventListener("click", function () { e.stop() });
});