...
<div>
	...
	<!--
		<div class="center">	
			<label for="button-search" class="point9em">search by domain name (add [/subdirectory] if needed).</label><br>
			<select id="button-search" type="text" name="site" value="" class="mt-12">
		...
		<div id="locatetopperwrap">
			<div style="text-align:center;margin-top:-24px;">
				<button id="locatetopper" onclick='javascript:document.getElementById("button-search").scrollIntoView();'> &#8593; </button>
			</div>
		</div>
	-->
	<div id="buttons">
