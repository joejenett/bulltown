...
<div style="/*position:relative;float:right;margin:24px 9px 0 9px;padding-left:2px;padding-bottom:9px;text-align:center;z-index:1000;*/">
	...
	<div id="buttons" style="text-align:center;margin-top:24px;clear:both;">
					<button id="play-gif" class="gbutton" style="border:none;"><a name="playg"><img src="/images/playg.png"></a></button>
					<button id="stop-gif" class="gbutton" style="border:none;"><a name="stopg"><img src="/images/stopg.png"></a></button>
